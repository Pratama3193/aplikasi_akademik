                ...
                CarouselSlider(
                  items: [
                    JadwalItem('SI-110', 'Algoritma', 'GB-0021',
                        'Lorem, S.T., M.Eng.', '7.00'),
                    JadwalItem('SI-120', 'Jaringan Komputer', 'GB-0031',
                        'Jhon Doe', '10.00'),
                    JadwalItem('SI-210', 'Bahasa Indonesia', 'GK-0001',
                        'xyz, S.Pd., M.Pd.', '13.00'),
                    JadwalItem('SI-210', 'Bahasa Indonesia', 'GK-0001',
                        'abcdefgh, S.Pd., M.Pd.', '13.00'),
                  ],
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                image: AssetImage("asset/images/news_1.jpeg"),
                fit: BoxFit.cover,
              ),
            ),
            child: Text(
              'Pentingnya memahami jurusan Informatika',
              style: TextStyle(
                fontSize: 14,
                fontWeight: FontWeight.bold,
